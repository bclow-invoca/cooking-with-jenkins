...
default['jenkins-ci']['jenkins']['job']['managed_directory'].tap do |job|
...
default['jenkins-ci']['jenkins']['job']['mcollective'].tap do |job|
...
default['jenkins-ci']['jenkins']['job']['test'].tap do |job|
  job['name']          = "test"
