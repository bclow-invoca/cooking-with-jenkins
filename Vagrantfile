...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider "vmware_fusion" do |v, override|
    override.vm.box_url = "https://opscode-vm-bento.s3.amazonaws.com/vagrant/vmware/opscode_ubuntu-14.04_chef-provisionerless.box"
  end
  ...
  # config.vm.network :private_network, ip: "10.100.10.100"
